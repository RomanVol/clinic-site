...
הודעה זו נשלחה מטופס יצירת קשר באתר
    ...
    alert('הפנייה נפתחה בוואטסאפ! שלח את ההודעה כדי שנוכל לחזור אליך.')
  }
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-8">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h3 className="text-2xl font-bold text-gray-800">שלח הודעה בוואטסאפ</h3>
      </div>
      ...
      <div className="mt-4 p-3 bg-green-50 rounded-lg text-sm text-green-700">
        💡 הלחיצה תפתח את וואטסאפ עם ההודעה מוכנה. פשוט שלח אותה ונחזור אליך בהקדם!
      </div>
    </div>
  )
}
