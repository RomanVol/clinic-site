      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300" aria-label="רשימת טיפולים">
          ...
          <div>
            ...
            <address className="not-italic space-y-3 text-gray-300">
              <a href="tel:052-553-3295" className="flex items-center hover:text-white transition duration-300" aria-label="התקשר: 052-553-3295">
                <span className="ml-2" aria-hidden="true">📞</span>
                <span>052-553-3295</span>
              </a>
              <a href="mailto:ronenmaga@gmail.com" className="flex items-center hover:text-white transition duration-300" aria-label="שלח אימייל: ronenmaga@gmail.com">
                <span className="ml-2" aria-hidden="true">📧</span>
            ...
            <div className="mt-6">
              ...
              <div className="flex space-x-4 space-x-reverse">
                <a 
                  href="https://www.facebook.com/profile.php?id=100077433684507" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="hover:opacity-80 transition duration-300"
                  aria-label="עקבו אחרינו בפייסבוק (נפתח בחלון חדש)"
                >
                  <svg className="w-8 h-8" viewBox="0 0 24 24" fill="#1877F2" aria-hidden="true">
                ...
                <a 
                  ...
                  aria-label="עקבו אחרינו ביוטיוב"
                >
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-300 text-sm">
              © {new Date().getFullYear()} מרפאת רונן. כל הזכויות שמורות.
            </div>
            <nav className="flex gap-6 mt-4 md:mt-0" aria-label="קישורים משפטיים">
              <Link href="/terms" className="text-gray-300 hover:text-white text-sm transition duration-300">
                תנאי שימוש
              </Link>
              <Link href="/privacy-policy" className="text-gray-300 hover:text-white text-sm transition duration-300">
                מדיניות פרטיות
              </Link>
              <Link href="/accessibility" className="text-gray-300 hover:text-white text-sm transition duration-300">
                הצהרת נגישות
              </Link>
            </nav>
          </div>
